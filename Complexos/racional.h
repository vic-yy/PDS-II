...
class Racional {
 public: //O que é público é aquilo que o usuário vai usar para interagir(como faz soma, divisão etc)
  // Cria o número 0/1.
  Racional();
 ...
 private:  //Significa que só pode ser acessado por métodos racionais
            //É aquilo que o programadr vai implementar
